<template>
    <v-container class="d-flex justify-center">
        ...
        <v-card max-height="300px" min-height="225px" height="auto" width="300px" class="mx-1" outlined
            ...
            <div v-if="isCameraOpen" class="d-flex align-center" style="height: 100%;">
                <video v-show="!isPhotoTaken" ref="camera" autoplay style="width:100%;object-fit: cover;" muted></video>
            </div>
            <div class="camera-button" v-else >
        ...
        <v-card max-width="600px" outlined>
            <v-card-text>
                <div id="content_activar_screen">
                    <div id="content_activar_screen">
                        ...
                        <ul>
                            <li>Asegúrese de que no se registre ningún dato personal o privado. Se recomienda tener
                                abierta la ventana del examen únicamente.</li>
            ...
            <v-card-actions class="d-flex justify-center">
                <v-btn depressed @click="toggleCamera">
                    Capturar
                </v-btn>
            </v-card-actions>
        </v-card>
